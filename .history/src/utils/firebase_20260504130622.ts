...
export const configureGoogleSignIn = (): void => {
  try {
    GoogleSignin.configure({
      ...
      webClientId: "930179066116-u9icm5hq0k8j3g6f5o0hq85aop90l7dq.apps.googleusercontent.com", 930179066116-h63ic6o8pl48sdma4lqggvtbrr3skvvr.apps.googleusercontent.com
      offlineAccess: true,
    });
